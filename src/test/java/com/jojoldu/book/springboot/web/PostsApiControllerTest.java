...
public class PostsApiControllerTest {
    ...
    public void Posts_등록된다() throws Exception {
        ...
        //when
        //기존ResponseEntity<Long> responseEntity = restTemplate.postForEntity(url, requestDto, Long.class);
        ...
        //then
        //기존 assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
    ...
    public void Posts_수정된다() throws Exception {
        ...
        //when
        //기존ResponseEntity<Long> responseEntity = restTemplate.exchange(url, HttpMethod.PUT, requestEntity, Long.class);
        mvc.perform(put(url)
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .content(new ObjectMapper().writeValueAsString(requestDto)))
                .andExpect(status().isOk());
